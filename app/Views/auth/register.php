    ...
    <div class="container">
      <div class="row align-items-center justify-content-between">
        <div class="col-lg-6 mb-4 mb-lg-0">
          ...
          <form action="<?= base_url('register/prosesregister') ?>" method="post" class="p-4 shadow-sm bg-white rounded-4">
            <div class="mb-3">
            ...
            <div class="mb-4">
              ...
              <input type="password" class="form-control" name="confirm" placeholder="Masukkan Kembali Password Anda...." required>
            </div>
